...
namespace RazorSharp
{
	public static class Jit
	{
		...
		{
			CorJitCompiler.CorJitResult CompileMethod(IntPtr                 thisPtr, [In] IntPtr corJitInfo,
													  [In] CorInfo*          methodInfo,
													  CorJitFlags.CorJitFlag flags, [Out] IntPtr nativeEntry,
		...
		public unsafe class CorJitCompiler
		{
			...
			// else			"Mscorjit.dll"
			[DllImport("Clrjit.dll", CallingConvention = CallingConvention.StdCall, SetLastError = true,
				EntryPoint                             = "getJit", BestFitMapping                = true)]
			...
			public static extern void DumpMethodInfo(IntPtr                 corJitInfo, CorInfo* methodInfo,
													 CorJitFlags.CorJitFlag flags,
													 IntPtr                 nativeEntry, IntPtr nativeSizeOfCode);

			[UnmanagedFunctionPointer(CallingConvention.StdCall, SetLastError = true)]
			public unsafe delegate CorJitResult CompileMethodDel(IntPtr                 thisPtr,
																 [In] IntPtr            corJitInfo,
																 [In] CorInfo*          methodInfo,
																 CorJitFlags.CorJitFlag flags,
																 [Out] IntPtr           nativeEntry,
