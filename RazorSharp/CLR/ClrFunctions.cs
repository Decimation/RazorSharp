	...
	internal static unsafe class ClrFunctions
	{
		...
		private static class GCFunctions
		{
			...
			private static readonly byte[][] Functions =
			{
				...
				new byte[]
				{
					0x48, 0x83, 0xEC, 0x28, 0x48, 0x3B, 0x15, 0x00 /* ? */, 0x00 /* ? */, 0x3B, 0x00, 0x48, 0x8B, 0xC2,
					0x73, 0x20
				},
				...
				new byte[]
				{
					...
					0x8B, 0x3D, 0xDE, 0x00 /* ? */, 0x93, 0x00, 0x33, 0xC0
				},
		...
		private static class JITFunctions
		{
			...
			private const long FN_JITGETRUNTIMETYPE_OFFSET = 0xE560;
		...
		private static class FieldDescFunctions
		{
			...
			private static readonly byte[][] Functions =
			{
				...
				new byte[]
				{
					0x53,
					0x48, 0x83, 0xEC, 0x20,
					0x83, 0x3D, 0x00 /* ? */, 0x00 /* ? */, 0x92, 0x00, 0x00,
					0x48, 0x8B, 0xD9,
		...
		private static class MethodDescFunctions
		{
			...
			private static readonly byte[][] Functions =
			{
				...
				new byte[]
				{
					0x48, 0x89, 0x5C, 0x24, 0x08, 0x57, 0x48, 0x83, 0xEC, 0x20, 0x48, 0x8B, 0xF9, 0xE8, 0x00 /* ? */,
					0x00 /* ? */,
					0x00 /* ? */, 0xFF, 0x33, 0xDB, 0x0F, 0xBA, 0xE0, 0x0C, 0x0F, 0x82, 0x00 /* ? */, 0x00 /* ? */,
					0x00 /* ? */, 0x00 /* ? */
				},
				...
				new byte[]
				{
					0x53, 0x48, 0x83, 0xEC, 0x20, 0x83, 0x3D, 0xE4, 0x28, 0x93, 0x00, 0x00, 0x48, 0x8B, 0xD9, 0x0F,
					0x85, 0x73, 0xC0, 0x2D, 0x00, 0x0F, 0xB6, 0x43, 0x02, 0x0F, 0xB7, 0x0B
				},
				...
				new byte[]
				{
					...
					0xA8, 0x01, 0x0F, 0x85, 0x00 /* ? */, 0x00 /* ? */, 0x00 /* ? */, 0x00 /* ? */, 0x33, 0xC0, 0xEB,
					0x01, 0xCC
				},
				...
				new byte[]
				{
					0x0F, 0xB7, 0x41, 0x06, 0x4C, 0x8D, 0x05, 0x00 /* ? */, 0x00 /* ? */, 0x6F, 0x00, 0x8B, 0xD0, 0x83,
					0xE2, 0x1F
				},
				...
				new byte[]
				{
					0x53,
					0x48, 0x83, 0xEC, 0x20,
					0x83, 0x3D, 0xB4, 0x89, 0x93, 0x00, 0x00,
					0x48, 0x8B, 0xD9,
					0x0F, 0x85, 0x4C, 0x20, 0x2E, 0x00,
					0x0F, 0xB6, 0x43, 0x02,
					0xC1, 0xE0, 0x03,
					0x48, 0x63, 0xD0,
					0x48, 0x2B, 0xDA,
				...
				new byte[]
				{
					...
					0xDA, 0x48, 0x8B, 0xF9, 0xE8, 0x1B, 0x24, 0xFE, 0xFF, 0x48, 0x8B, 0xCF
				},
